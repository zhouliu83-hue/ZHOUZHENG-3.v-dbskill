...
**v3.14.2 更新**：优化 `/dbs-chatroom` 的推荐人物规则。推荐专家时不再靠固定名单或泛名人直觉，改为先判断话题缺什么视角，再选择真正能推进讨论的人；同时明确排除泛财经、泛商业、靠表达和传播出名但判断密度偏弱的人。

**v3.14.1 更新**：修复 `/dbs-content-system` 发布包缺少 `scaffold/root/AGENTS.md`、`CLAUDE.md`、`SOURCE_OF_TRUTH.md` 的问题。`v3.14.0` 新增了正式版内容结构化系统，本版本补齐初始化脚本依赖的根级脚手架文件。
...
<img width="961" height="526" alt="image" src="https://github.com/user-attachments/assets/f3dc227f-6cc3-4952-bf8c-6fb7c594477a" />
<img width="1112" height="656" alt="image" src="https://github.com/user-attachments/assets/b8db62d3-7e3f-49e7-8d63-fb3e675ed613" />
<img width="1113" height="626" alt="image" src="https://github.com/user-attachments/assets/5c03aead-cde8-4507-a84e-54db4e18d713" />
...
``zhouliu83-hue/ZHOUZHENG-3.v-dbskill
...
帮我安装zhouliu83-hue/ZHOUZHENG-3.v-dbskill该仓库技能
...
读取 `zhouliu83-hue/ZHOUZHENG-3.v-dbskill技能列表，
读取 `zhouliu83-hue/ZHOUZHENG-3.v-dbskill` 获取单个技能详情。
